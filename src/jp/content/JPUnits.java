...
public class JPUnits {
    ...
    public static <T extends Entityc> int classID(Class<T> type) {
        ...
        DeathImp = new UnitType("DeathImp"){{
            ...
            outlineColor = Color.valueOf("303a45");
            abilities.add(new MoveEffectAbility(-5f, -7f, Pal.sapBulletBack, Fx.missileTrailShort, 4f){{
                teamColor = true;
            }});
            abilities.add(new MoveEffectAbility(5f, -7f, Pal.sapBulletBack, Fx.missileTrailShort, 4f){{
                teamColor = true;
        ...
        Thera = new UnitType("Thera"){{
            ...
            healColor = Color.valueOf("590e14");
            outlineColor = Color.valueOf("303a45");
            abilities.add(new MoveEffectAbility(-5f, -3f, Pal.sapBulletBack, Fx.missileTrailShort, 4f){{
                teamColor = true;
            }});
            abilities.add(new MoveEffectAbility(5f, -3f, Pal.sapBulletBack, Fx.missileTrailShort, 4f){{
                teamColor = true;
